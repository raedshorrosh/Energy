...
[[jsxgraph  width="800px" height="400px"  input-ref-states='statesRef'  input-ref-ans1='DHtot'  input-ref-DHval1='DHst1' input-ref-DHval2='DHst2' input-ref-DHval3='DHst3' input-ref-DHval4='DHst4']]
...
//----
var DHSt=[document.getElementById(DHst1),document.getElementById(DHst2),document.getElementById(DHst3),document.getElementById(DHst4)];
//----
...
else  for (let ii=0;isless(ii,jmax);ii++) {answers[ii]=1;ans.value=JSON.stringify(answers);Einput[ii].set('');ans.dispatchEvent(new Event('change'));}
